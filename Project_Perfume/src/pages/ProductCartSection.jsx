...
//     return (
//         <div className="bg-[#fff9c7] px-6 py-10 font-sans text-[#3b220c]">
//             {/* Top Section */}
...
//                         <img
//                             src={amberNocturne1} // First small image
//                             alt="Thumbnail 1"
//                             className="w-[100px] h-auto object-contain rounded shadow"
//                         />
//                         <img
//                             src={amberNocturne1} // Second small image
//                             alt="Thumbnail 2"
//                             className="w-[100px] h-auto object-contain rounded shadow"
//                         />
//                     </div>
...
//                     <h2 className="text-3xl font-bold mb-2">Ember Nocturne</h2>
//                     <p className="text-sm text-gray-700 mb-1">Lavender, Cedar, & Amber</p>
//                     <p className="text-[15px] leading-relaxed mb-4">
//                         Something something something something something something something something.
//                     </p>
//                     <p className="text-xl font-semibold mb-4">$499</p>
...
//                     {/* Personalize Button */}
//                     <div className="mb-4">
//                         <button className="text-sm underline underline-offset-2 text-[#3b220c] hover:text-[#5e160e]">
...
//                         <div className="flex items-center border border-[#3b220c] px-2">
...
//                         </div>
//                         <button className="bg-[#3b220c] text-white px-6 py-2 text-sm font-medium hover:bg-[#5e160e]">
//                             Add to Cart
//                         </button>
//                     </div>
//                 </div>
...
//             {/* Divider */}
//             <div className="h-px bg-[#c2a85c] my-12 w-full" />

//             {/* Highlights Section */}
//             <div className="bg-[#fff9c7] py-12 px-6 md:px-16 space-y-20">
//                 {/* Aventus Collection */}
//                 <div className="flex flex-col md:flex-row items-center justify-between gap-10">
//                     <div className="md:w-1/2 space-y-4">
//                         <h3 className="text-xl font-semibold text-[#4B0000]">The Aventus Collection</h3>
...
//                         <img
//                             src={amberNocturne1}  // replace with actual path or import
//                             alt="Aventus Bottle"
//                             className="max-w-xs w-full rounded"
//                         />
//                     </div>
//                 </div>
...
//                     </div>
//                     <div className="md:w-1/2 space-y-4">
//                         <h3 className="text-xl font-semibold text-[#4B0000]">A Fragrance Of True Distinction</h3>
//                         <p className="text-sm text-[#333]">
