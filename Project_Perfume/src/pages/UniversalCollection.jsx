...
// import millesimeImperial from './Men/assets/aventus1.jpg';
// import amberNocturne2 from './Men/assets/aventus1.jpg';

// const UniversalCollection = () => {
//   return (
//     <div className='bg-[#B9AF7A] w-full'>
//       <Header />
//       <main className="max-w-7xl bg-[#B9AF7A] mx-auto py-12 px-4">
//         {/* Exclusive Fragrances Section */}
//         <section className="mb-12">
//           <h1 className="text-3xl font-semibold text-gray-800 mb-4">Exclusive Fragrances</h1>
//           <p className="text-#B9AF7A">
//             Immerse yourself in a world of unrivaled quality with an extraordinary perfume for women from The
//             House of Creed, artfully crafted using only the finest natural ingredients. From timeless classic Aventus
//             For Her to the newest floral rose masterpiece in Eldoria, elegant yet empowering feminine scent, every
...
//         {/* Universal Collection Section 1: Amber Nocturne */}
//     <section className="bg-[#B59248] text-[#4A1F18] py-12 px-6">
...
//           <a
//             href="#"
//             className="text-sm font-semibold border-b-2 border-[#4A1F18] hover:text-[#2f110c] transition duration-300"
//           >
//             Discover More
//           </a>
//         </div>
...
//     <section className=" text-[#4A1F18] py-12 px-6">
//       <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
//         {/* Text Content */}
//         <div className="w-full md:w-1/2">
//           <h2 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">
...
//         {/* Universal Collection Section 3: Amber Nocturne (again) */}
//         {/* <section className="mb-12">
//           <h2 className="text-2xl font-semibold text-gray-800 mb-4">Universal Collection</h2>
...
//             </div>
//             <div className="w-2/3">
//               <h3 className="text-xl font-semibold text-gray-800 mb-2">Meet Vesarii Amber Nocturne</h3>
...
//           <h1 className="text-3xl font-semibold text-[#79300f] dark:text-[#F6E5E5] mb-4 px-8">Exclusive Fragrances</h1>
//           <p className="text-[#3d2b1f] dark:text-[#F6E5E5] px-8">
...
//         <section className="w-full bg-[#B59248] dark:bg-[#021612] text-[#79300f] dark:text-[#f6d110] py-12 px-6">
...
//               <h2 className="text-3xl md:text-4xl font-bold mb-4 leading-tight dark:text-[#F6E5E5]">Amber Nocturne</h2>
//               <p className="text-md md:text-lg leading-relaxed mb-6 text-[#3d2b1f] dark:text-[#F6E5E5] ">
//                 Meet VESARII Ember Nocturne — a perfume forged in twilight, kissed
//                 by wild lavender, smoked cedar, and a whisper of fire-kissed amber.
//                 Designed to enchant from the very first breath.
//               </p>
...
//         {/* Universal Collection Section 2: Millésime Impérial */}
//         <section className="bg-[#C0BA87] dark:bg-[#220104] text-[#79300f] dark:text-[#F6E5E5] py-12 px-6">
//           <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
//             {/* Text Content */}
//             <div className="w-full md:w-1/2 px-4">
//               <h2 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">Millésime Impérial</h2>
//               <p className="text-md md:text-lg leading-relaxed mb-6 text-[#3d2b1f] dark:text-white">
//                 Fresh and uplifting, Millésime Impérial radiates brilliance from
//                 the outset with its vibrant debut of zesty bergamot, luscious
//                 blackcurrant and refreshing violet leaves that gives way to a
//                 shimmering marine accord. Prized orris, the perfumer’s blue gold,
...
//         {/* Universal Collection Section 3: Amber Nocturne */}
//         <section className="bg-[#B59248] dark:bg-[#021612] text-[#79300f] dark:text-[#F6E5E5] py-12 px-6">
//           <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
//             {/* Perfume Image */}
//             <div className="w-full md:w-1/2 flex justify-center">
//               <img
...
//             {/* Text Content */}
//             <div className="w-full md:w-1/2">
//               <h2 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">Amber Nocturne</h2>
//               <p className="text-md md:text-lg leading-relaxed mb-6 text-[#3d2b1f] dark:text-white">
//                 Meet VESARII Ember Nocturne — a perfume forged in twilight, kissed
//                 by wild lavender, smoked cedar, and a whisper of fire-kissed amber.
//                 Designed to enchant from the very first breath.
...
//         {/* <section className="mb-12">
//           <h2 className="text-2xl font-semibold text-[#79300f] dark:text-[#f6d110] mb-4">Universal Collection</h2>
//           <div className="flex space-x-8">
//             <div className="w-1/3">
//               <img
//                 src={amberNocturne2}
...
//             </div>
//             <div className="w-2/3">
//               <h3 className="text-xl font-semibold text-[#79300f] dark:text-[#f6d110] mb-2">Meet Vesarii Amber Nocturne</h3>
