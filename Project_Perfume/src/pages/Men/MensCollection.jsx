...
//         {/* Women's Fragrances Section */}
//         <section className="mb-12">
//           <h1 className="text-3xl font-semibold text-gray-800 mb-4">Men's Fragrances</h1>
//           <p className="text-gray-600">
//             Creating iconic hand-crafted perfume for men, Creed has established a legacy of acclaimed
//             fragrance, cologne and aftershave for men. Explore our collection of bestselling Creed men's
//             fragrances including Creed Aventus, Creed Bois du Portugal, Creed Viking, Creed Silver Mountain Water,
...
//         <section className="mb-12">
//           <h1 className="text-3xl font-semibold text-[#79300f] dark:text-[#EDD1D1] mb-4">Men's Fragrances</h1>
//           <p className="text-[#3d2b1f] dark:text-[#EDD1D1]">
//             Creating iconic hand-crafted perfume for men, Creed has established a legacy of acclaimed
//             fragrance, cologne and aftershave for men. Explore our collection of bestselling Creed men's
//             fragrances including Creed Aventus, Creed Bois du Portugal, Creed Viking, Creed Silver Mountain Water,
//             the classic and woody Royal Oud and Green Irish Tweed.
...
//         {/* Popular Products Section */}
//         <section className="mb-12">
//           <h2 className="text-2xl font-semibold text-[#79300f] dark:text-[#EDD1D1] mb-4">Popular Products</h2>
//           <div className="flex space-x-4 mb-6">
...
//         {/* Exclusive Fragrances Section */}
//         <section className="mb-12">
//           <h2 className="text-2xl font-semibold text-[#8B5A2B] dark:text-[#EDD1D1] mb-4">Explore Exclusive Fragrances</h2>
//           <div className="flex space-x-8">
//             <div className="w-1/3">
//               <img
//                 src={millesime}
...
//             </div>
//             <div className="w-2/3">
//               <h3 className="text-xl font-semibold text-[#79300f] dark:text-[#EDD1D1] mb-2">Millésime Impérial</h3>
//               <br/>
